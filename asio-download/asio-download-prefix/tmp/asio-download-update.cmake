...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("22afb86" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/22afb86")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      _ep_message_quiet_capture(FATAL_ERROR
        "\nFailed to rebase in: '/home/ec2-user/q-bot/sleepy-discord/deps/asio'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      _ep_accumulate_captured_output()
      _ep_message_quiet_capture(FATAL_ERROR
        "Failed to unstash changes in: '/home/ec2-user/q-bot/sleepy-discord/deps/asio'.\n"
        "You will have to resolve the conflicts manually"
      )
    endif()
  endif()
